...
if(isset($_POST['email'])) {
  ...
  if(!preg_match($string_exp,$question_1_A)) {
 
    $error_message .= 'The answer you entered does not appear to be valid.<br />';
 
  }
 
  if(!preg_match($string_exp,$question_1_B)) {
 
    $error_message .= 'The answer you entered does not appear to be valid.<br />';
 
  }
 
  if(strlen($question_1_C) < 2) {
